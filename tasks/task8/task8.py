...
avg_temp = np.mean(list(map(float,(sensor_data[:,2]))))
avg_stress = np.mean(list(map(float,(sensor_data[:,3]))))
avg_dis = np.mean(list(map(float,(sensor_data[:,4]))))
print(avg_temp)
print(avg_stress)
print(avg_dis)
print("...................................................................................")
